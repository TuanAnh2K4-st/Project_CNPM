...
<!-- SECTION -->
<%--3.3.1. Trang giohang.jsp lấy giỏ hàng từ HttpSession thông qua: Cart cart = (Cart) session.getAttribute("cart");--%>
<%
    Cart cart = (Cart) session.getAttribute("cart");
    List<CartProduct> cartProducts = cart != null ? cart.getCartProducts() : null;
// 3.3.2. Kiểm tra cart có tồn tại không:
    if (cart != null) {
...
<%--                        3.3.3. Tính tổng tiền của giỏ hàng: --%>
